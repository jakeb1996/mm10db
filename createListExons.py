...
if len(sys.argv) > 2:
    print "Usage: python createListExons.py [ID for list of genes]"
    quit ()
...
if len(sys.argv) == 1:
    ...
    out_ = "exonList.txt"[:-4]+"_"+filename
...
cmd = "sort -k 2,2 -k4,4n "+dir+out_+" > "+dir+"temp.txt && mv "+dir+"temp.txt "+dir+out_
call([cmd],shell=True)
