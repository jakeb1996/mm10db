...
inputFile_exon = "exon_sequences.txt"
...
accepted_targets = dir_trg+"accepted_targets.txt"
accepted_targets_sorted = dir_trg+"accepted_targets_sortedByGene.txt"
accepted_targets_Excel = dir_trg+"accepted_targets_ExcelFriendly.tsv"
rejected_targets = dir_trg+"rejected_targets.txt"

exon_list = "exonList.txt"
offTargetSites = dir_seq+"offtargetSites.txt"
nb_threads_C = "1"
nb_threads_Bowtie = "1"
...
cmd = "bowtie2 -x mm10_input/mm10_Bowtie2/mm10 -p "+nb_threads_Bowtie+" --reorder --no-hd -t -r -U "+tempTargetFile+" -S "+alignmentFile
call([cmd],shell=True)
